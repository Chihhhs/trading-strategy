...
| P1 | Cross-sectional momentum | The 4h 14-day market-neutral momentum portfolio passed 4/5 development folds, 24/30 normal and stressed anchor scenarios, and its one-time 120-day holdout (+15.48% net, 2.25 Sharpe, 7.07% max DD) using exact historical funding. | Run isolated target-weight shadow observation only. No live orders or live-config change until forward evidence, point-in-time universe review, execution reconciliation, and a separate live-safety approval. | `docs/research_manual/14_cross_sectional_momentum_shadow_2026-07-17.md`, `data/research_artifacts/independent_strategy_search_4h_actual_funding_holdout.json` |
