...
def apply_closed_trade(state, pos, exit_price, exit_reason, *, exit_time=None, update_balance=True, exit_context=None):
    trade = build_trade_record(pos, exit_price, exit_reason, exit_time=exit_time, exit_context=exit_context)
