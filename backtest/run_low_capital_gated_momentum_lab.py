"""Hourly momentum that enters only in an already-confirmed directional regime."""
...
def main():
    ...
    parser.add_argument("--output", default="data/research_artifacts/low_capital_gated_momentum.json")
    ...
    route = {
        "route": "gated_regime_momentum",
        "hypothesis": "only impulses already aligned with longer trend and path efficiency deserve entry and continuation",
