"""Hourly regime momentum with long/cash or smaller-short asymmetry."""
...
def main():
    ...
    parser.add_argument("--output", default="data/research_artifacts/low_capital_asymmetric_momentum.json")
    ...
    if validation[1] >= development_start:
        raise ValueError("asymmetric validation overlaps development")
    evaluated = []
    ...
    route = {
        "route": "asymmetric_regime_momentum",
        "hypothesis": "confirmed upside momentum deserves more exposure than bearish momentum in positive-drift crypto markets",
